    ...
    init {
        viewModelScope.launch {
            combine(
                ...
                tasksRepository.getExerciseProgramsWithExercisesAndConnections()
            ) { simpleTasks, exercises, exerciseProgramExerciseConnection, exerciseProgramsWithExercisesAndConnections ->
                TasksUiState(
                    simpleTasks = simpleTasks,
                    exercises = exercises,
                    exerciseProgramExerciseConnection = exerciseProgramExerciseConnection,
                    exerciseProgramsWithExercisesAndConnections = exerciseProgramsWithExercisesAndConnections,
                )
            }
                .catch { throwable ->
                    throw throwable
