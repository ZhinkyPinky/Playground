package com.je.playground.view.navigationdrawer
...
import com.je.playground.view.MainScreen
import com.je.playground.view.Route
        ...
        icon = {
            Icon(
                imageVector = when (mainScreen) {
                    ...
                    MainScreen.ExerciseProgramList -> Icons.Filled.DirectionsRun
                },
