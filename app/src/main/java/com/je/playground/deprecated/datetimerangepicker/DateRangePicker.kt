        ...
        MonthGridComponent(
            ...
            onDateChosen = {
                if (startDateOrEndDate) {
                    ...
                    if (newStartDate == null || newStartDate!!.isEqual(it) || newStartDate!!.isBefore(
                            it
                        )
                    ) {
                        newEndDate = it
    ...
    TextButton(
        ...
        colors = ButtonDefaults.buttonColors(
            containerColor = if (startDate != null && endDate == null && startDate.isEqual(date)) {
                Color(0xFFFFAB00)
            } else if (startDate != null && endDate != null && startDate.isBefore(date.plusDays(1)) && endDate.isAfter(
                    date.minusDays(1)
                )
            ) {
                Color(0xFFFFAB00)
